...
export const BODY_SPRITE =
  ...
  <symbol id="body-SUV-Small" viewBox="0 0 72 30.7"><path fill-rule="evenodd" d="M40.49,2.11 L50.81,2.23 L61.74,3.93 L61.14,5.02 L66.84,8.79 L67.94,10.36 L67.94,14.74 L69.15,15.95 L69.15,19.11 L67.33,21.17 L63.69,22.14 L61.86,16.68 L58.83,14.61 L55.91,14.37 L52.76,15.59 L51.18,17.16 L50.21,19.35 L49.84,22.63 L22.4,23.11 L22.28,20.56 L20.34,16.68 L18.03,15.1 L15.84,14.61 L13.66,14.86 L10.62,16.68 L8.92,19.35 L8.31,23.6 L4.91,23.11 L3.09,21.54 L2.85,16.19 L5.16,13.16 L12.2,10.73 L20.21,9.76 L26.77,5.63 L31.87,3.44 Z M41.34,3.2 L36.24,3.69 L31.14,5.14 L27.74,6.84 L23.25,10.36 L38.91,10.0 L58.59,8.06 L58.95,7.21 L57.61,6.11 L52.76,4.17 Z M14.26,16.92 L16.57,16.8 L18.51,17.53 L20.58,19.59 L21.31,21.29 L20.82,25.42 L18.76,27.73 L17.3,28.46 L12.93,28.21 L10.62,26.39 L9.41,23.72 L9.41,21.54 L10.38,19.35 L11.96,17.77 Z M55.55,16.92 L57.86,16.8 L59.8,17.53 L61.86,19.35 L62.59,21.05 L62.59,24.21 L61.86,25.91 L58.59,28.46 L54.21,28.21 L52.15,26.64 L50.94,24.45 L50.69,22.75 L51.66,19.35 L53.73,17.53 Z"/></symbol>
...
// in practice — "Van" was simply missing from the old emoji map. SUV is both the generic shape
// and by far the most common body style.
//
// "SUV" alone is a very wide bucket, so a second silhouette splits it: EPA's Small SUV class
// gets the lower, shorter shape originally drawn for the retired "Crossover" body style. That
// drawing was a good likeness with nowhere to live once the concept was dropped (2026-08-28,
// see data/SCHEMA.md), and a small SUV is exactly what it depicts. 47 of the 84 classed SUVs are
// Small, so this distinguishes a third of the grid rather than being a rare special case. The 10
// SUVs with no epaSizeClass keep the generic shape, which is the honest default.
//
// Takes the whole car rather than a body style string, since the choice now needs two fields.
export function bodyIcon(car) {
  const style = car?.bodyStyle;
  let key = BODY_STYLES.has(style) ? style : "SUV";
  if (key === "SUV" && car?.epaSizeClass === "Small SUV") key = "SUV-Small";
